...
$post_data['cus_add1'] = isset($_POST['address']) ? $_POST['address'] : "Dhaka";
...
// Decode cart items as associative arrays.
// NOTE: json_decode() without the 2nd param returns stdClass objects, which can break cURL payload building.
$cart_items = [];
if (isset($_POST['cart_items']) && $_POST['cart_items'] !== '') {
...
// SSLCOMMERZ expects 'cart' as a JSON string (not an object/array)
$post_data['cart'] = json_encode($cart_items, JSON_UNESCAPED_UNICODE);

// Keep a copy for local DB insert logic
$post_data['cart_items'] = $cart_items;
